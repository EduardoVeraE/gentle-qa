...
- Open a pull request on [EduardoVeraE/Gentle-QA](https://github.com/EduardoVeraE/Gentle-QA)
...
1. Confirm the issue has status:approved
   gh issue view <N> --repo EduardoVeraE/Gentle-QA
...
```bash
gh pr checks --repo EduardoVeraE/Gentle-QA <PR-number>
gh pr view --repo EduardoVeraE/Gentle-QA <PR-number>
```

### Add a Label

```bash
gh pr edit <PR-number> --repo EduardoVeraE/Gentle-QA --add-label "type:bug"
```
