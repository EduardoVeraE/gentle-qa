...
- Open any GitHub issue on the [EduardoVeraE/Gentle-QA](https://github.com/EduardoVeraE/Gentle-QA) repository
...
4. **Questions go to Discussions** — use [GitHub Discussions](https://github.com/EduardoVeraE/Gentle-QA/discussions), NOT issues, for questions and general conversation.
...
1. Search existing issues → confirm it's not a duplicate
   https://github.com/EduardoVeraE/Gentle-QA/issues
...
```
https://github.com/EduardoVeraE/Gentle-QA/issues/new?template=bug_report.yml
```
...
Or open the web form directly:
```
https://github.com/EduardoVeraE/Gentle-QA/issues/new?template=feature_request.yml
```
...
│         https://github.com/EduardoVeraE/Gentle-QA/discussions
...
```bash
# Search open issues
gh issue list --repo EduardoVeraE/Gentle-QA --state open --search "your keywords"

# Search all issues including closed
gh issue list --repo EduardoVeraE/Gentle-QA --state all --search "your keywords"
```
...
```bash
gh issue view <number> --repo EduardoVeraE/Gentle-QA
```
