...
import (
	...
	codexagent "github.com/EduardoVeraE/Gentle-QA/internal/agents/codex"
	"github.com/EduardoVeraE/Gentle-QA/internal/agents/cursor"
...
func TestGoldenSDD_Cursor(t *testing.T) {
	...
	// Cursor writes SDD orchestrator to ~/.cursor/rules/gentle-qa.mdc.
	rulesFile := readTestFile(t, filepath.Join(home, ".cursor", "rules", "gentle-qa.mdc"))
...
func TestGoldenSDD_Kiro(t *testing.T) {
	...
	// Kiro writes SDD orchestrator to ~/.kiro/steering/gentle-qa.md
