...
const (
	markerPrefix = "<!-- gentle-qa:"
	markerSuffix = " -->"
	closePrefix  = "<!-- /gentle-qa:"
)
...
// written to a markdown file outside of <!-- gentle-qa: --> markers.
//
...
// <!-- gentle-qa: --> marker). A fingerprint that exists only inside a marker
...
// written by the standalone ATL installer before gentle-qa superseded it.
...
// <!-- gentle-qa:sdd-orchestrator --> section, so keeping both wastes ~150
...
// Markers use HTML comments: <!-- gentle-qa:SECTION_ID --> ... <!-- /gentle-qa:SECTION_ID -->
