...
type Manifest struct {
	...
	// CreatedByVersion is the gentle-qa version that created this backup.
...
func backupRoot() (string, error) {
	...
	return filepath.Join(home, ".gentle-qa", "backups"), nil
}
...
// of the expected backup root (~/.gentle-qa/backups/). This prevents a tampered
