...
func TestBuildSyncSelectionDefaultScopeIncludesManagedComponents(t *testing.T) {
	...
	// Persona is included because the content between <!-- gentle-qa:persona -->
...
func TestComponentSyncStepRunsPersonaInjectForSync(t *testing.T) {
	...
	if !strings.Contains(string(body), "<!-- gentle-qa:persona -->") {
...
// gentle-qa sync excludes it from the plan and does not adopt it."
//
...
func TestRunSyncExcludesUnmanagedLookalikeFile(t *testing.T) {
	...
	const lookalikeContent = "# My project AGENTS.md — NOT managed by gentle-qa"
...
func TestRunSyncRegeneratesPersonaBlockBetweenMarkers(t *testing.T) {
	...
	// Write a stale managed persona block — what an older version of gentle-qa
