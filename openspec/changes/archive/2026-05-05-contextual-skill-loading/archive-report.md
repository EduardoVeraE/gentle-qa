...
3. **Opencode user-skill mechanism** — currently out of scope; gentle-qa's skill-registry and `load` directive only ship to Claude Code, not to OpenCode's manual import flow.
