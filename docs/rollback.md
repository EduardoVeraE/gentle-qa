...
Every time you run `gentle-qa install`, `sync`, or `upgrade`, the system:
...
1. Run `gentle-qa` and navigate to the **Backups** screen
...
2. Restore from latest snapshot via the TUI or `gentle-qa restore latest`
