...
```
~/.config/gentle-qa/custom-agents.json
```
...
sequenceDiagram
    participant User
    participant TUI as Gentle-QA TUI
...
graph TB
    ...
    subgraph STORAGE["Storage"]
        ...
        REGISTRY_FILE["~/.config/gentle-qa/custom-agents.json"]
...
| R-AB-08 | The Agent Builder MUST maintain a local registry of custom agents at `~/.config/gentle-qa/custom-agents.json` | P0 |
